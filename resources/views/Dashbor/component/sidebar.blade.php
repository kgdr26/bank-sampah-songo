<div class="sidebar-list">
    ...
    <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
        ...
        <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="{{ route('dasbor.index') }}">
                <i class="icon">
            ...
            <ul class="sub-nav collapse" id="horizontal-menu" data-bs-parent="#sidebar-menu">
                <li class="nav-item">
                    <a class="nav-link " href="">
                        ...
                        <span class="item-name"> Setor </span>
                    </a>
                    <a class="nav-link " href="">
                        <i class="icon">
                            <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                        ...
                        <span class="item-name"> Tarik </span>
                    </a>
                </li>
            </ul>
        </li>
        <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="#history-transaksi" role="button"
                aria-expanded="false" aria-controls="history-transaksi">
                <i class="icon">
                    <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path opacity="0.4"
                ...
                <span class="item-name">History Transaksi</span>
                <i class="right-icon">
                    <svg class="icon-18" xmlns="http://www.w3.org/2000/svg" width="18" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <ul class="sub-nav collapse" id="history-transaksi" data-bs-parent="#sidebar-menu">
                <li class="nav-item">
                    <a class="nav-link " href="{{ route('historysetor.index') }}">
                        <i class="icon">
                            <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                viewBox="0 0 24 24" fill="currentColor">
                                <g>
        ...
        <li class="nav-item">
            ...
            <ul class="sub-nav collapse" id="penjualan" data-bs-parent="#sidebar-menu">
                <li class="nav-item">
                    <a class="nav-link " href="{{ route('historysetor.index') }}">
                        <i class="icon">
                            <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                        ...
                        <span class="item-name"> Input Penjualan </span>
                    </a>
                    <a class="nav-link " href="">
                        <i class="icon">
                            <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
        ...
        <li class="nav-item">
            <a class="nav-link" aria-current="page" href="{{ route('anggota.index') }}">
                <i class="icon">
                    <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
        ...
        <li class="nav-item">
            <a class="nav-link" aria-current="page" href="">
                ...
                <span class="item-name">Pengurus</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" aria-current="page" href="">
                ...
                <span class="item-name">Sampah</span>
            </a>
        </li>
    </ul>
    <!-- Sidebar Menu End -->
